...
def color_hist(img, nbins=32, bins_range=(0, 255.0)):
...
def extract_features(imgs, train_data_tpye, color_space='RGB', spatial_size=(32, 32),
    ...
    for file in imgs:
        ...
        # png pixel vaule range is 0~1
        if train_data_tpye == 'png':
            image = image*255
